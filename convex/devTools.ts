...
export const redistributeHistoriaToJerga = mutation({
  ...
  handler: async (ctx) => {
    const JERGA_SET = new Set([
      ...
      "irse de rol","andar pedo","armarla de pedo","poner el cuerno",
      "no dar el ancho","caer gordo","estar cañón","chilango",
      "camión","micro","cuate","neta del planeta","ándale","andale",
      "metro","puchador","chaleco","machín","machin","morrita",
      ...
      "clica","tirar barrio","estar en la movida","cancelado","funar",
      "chismecito","stalkear","crush","shippear","postear",
      "subirse al tren","estar viral","meme","echar la hueva",
      "hacerse güey","ya valió madre","pendejo","cabrón","cabron",
      "vieja","jaina","tirar paro","crudo","ñero","pisto",
      "a'huevo","tuch","poch","pacha","jach","tuchito",
      "halcón","halcon","troca blindada",
    ]);

...
const NEW_ENTRIES = [
  // ── STREAMERS adicionales ──────────────────────────────────────────────────
  {
    ...
    region: "Digital", category: "Mundo Digital", difficulty: 2,
  },
  {
    word: "AURONPLAY",
  ...
  },
  {
    ...
    region: "México", category: "Mundo Digital", difficulty: 2,
  },
  {
    word: "IBAI LLANOS",
  ...
  // ── MÚSICOS adicionales ────────────────────────────────────────────────────
  {
    ...
    region: "Sonora", category: "Música y Artistas", difficulty: 2,
  },
  {
    word: "GRUPO FRONTERA",
    meaning: "Agrupación de música norteña de Texas con raíces mexicanas, viral en TikTok",
    example: "Grupo Frontera colaboró con Bad Bunny en 'Un x100to' que llegó al número 1 en Billboard Global y al Top 5 del Hot 100",
    region: "Texas/México", category: "Música y Artistas", difficulty: 2,
  },
  {
    word: "EDEN MUNOZ",
    ...
    region: "Sinaloa", category: "Música y Artistas", difficulty: 2,
  },
  {
    word: "BANDA MS",
  ...
  },
  {
    ...
    region: "Washington/México", category: "Música y Artistas", difficulty: 2,
  },
  {
  ...
  },
  {
    ...
    region: "México", category: "Música y Artistas", difficulty: 2,
  },
  {
    word: "GRUPO SOMBRA",
    ...
    region: "Jalisco", category: "Música y Artistas", difficulty: 2,
  },
  {
    word: "LUPILLO RIVERA",
    ...
    region: "Baja California", category: "Música y Artistas", difficulty: 2,
  },
];
  ...
  handler: async (ctx) => {
    ...
    for (const entry of NEW_ENTRIES) {
      ...
      await insertNewLevel(ctx, {
        ...
        wordId,
        reward: {
          coins: 2 + Math.floor((nextLevel - 1) / 100),
          diamonds: Math.floor((nextLevel - 1) / 200),
        },
      });

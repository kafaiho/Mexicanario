...
const testModules = [
  ...
  'src/config/gameFeedback.test.js',
  'src/config/minigameLogic.test.js',
...
const typescriptTestModules = [
  ...
  'convex/iapRecovery.test.ts',
  'convex/rewards.test.ts',
  'convex/weekId.test.ts',
  'convex/minigameRanking.test.ts',
  'convex/leagueStandings.test.ts',
  'convex/streakMath.test.ts',
  'src/store/petMoodLogic.test.ts',
  'src/config/petTypes.test.ts',
  'src/components/Pet3D/petModels.test.ts',
  'src/config/petHint.test.ts',
  'src/components/Pet3D/petGestures.test.ts',

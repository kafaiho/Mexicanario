...
const PLACES = [
  ...
  place('jalisco', 'Jalisco', 'state', 'Jalisciense', '🌵', '#388E3C'),
  ...
  place('veracruz', 'Veracruz', 'state', 'Veracruzano', '🎺', '#1565C0'),
  place('oaxaca', 'Oaxaca', 'state', 'Oaxaqueño', '🍫', '#E65100'),
  place('puebla', 'Puebla', 'state', 'Poblano', '🏺', '#5D4037'),
  place('michoacan', 'Michoacán', 'state', 'Michoacano', '🦋', '#6A1B9A', ['Michoacan']),
  place('guerrero', 'Guerrero', 'state', 'Guerrerense', '🏖️', '#00838F'),
  place('chiapas', 'Chiapas', 'state', 'Chiapaneco', '🌿', '#00695C'),
  place('yucatan', 'Yucatán', 'state', 'Yucateco', '🌺', '#7B1FA2', ['Yucatan']),
  place('campeche', 'Campeche', 'state', 'Campechano', '🏰', '#AD1457'),
  place('quintana-roo', 'Quintana Roo', 'state', 'Quintanarroense', '🐠', '#00897B'),
  place('tabasco', 'Tabasco', 'state', 'Tabasqueño', '🍫', '#558B2F'),
  place('nayarit', 'Nayarit', 'state', 'Nayarita', '🌊', '#0277BD'),
